    ...
    return (
        <Layout title='Produk Rekomendasi Lokaloka'>
            <div className='container mx-auto px-4 2xl:px-0 md:my-5 2xl:my-6'>
                ...
                <h1 className='text-2xl font-semibold text-blueGray-800 xl:my-2 2xl:my-3'>Rekomendasi</h1>
                <div className='flex space-x-8'>
                    <div className='w-full'>
                        ...
                        <div className='grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-5 sm:gap-4 2xl:gap-8 mt-4'>
