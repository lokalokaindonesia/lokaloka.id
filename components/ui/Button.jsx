const Button = ({ children, disabled = false, type = 'primary', size = 'base', href, width = 'max', display = 'block', buttonType = 'button' }) => {
    ...
    const types = {
        ...
        tertiary: `rounded-md shadow-lg shadow-orange-500/20 bg-orange-500 border-2 border-orange-500 text-white font-bold transiton duration-300 ease-in-out hover:scale-95 hover:border-orange-600`,
