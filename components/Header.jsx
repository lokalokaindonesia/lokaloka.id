        ...
        <header className='w-full px-4 h-20 xl:container xl:mx-auto flex justify-between items-center '>
            ...
            <div className='w-8/12 flex justify-center'>
                <div className='hidden xl:flex space-x-8 flex-initial font-medium text-blueGray-600'>
                    ...
                    <Link href='/category/food-and-beverages'>
                        Food & Beverages
                    </Link>
                ...
                <input
                    type='text'
                    className='block xl:hidden px-3 py-2 border border-gray-400 focus:outline-none text-blueGray-600 bg-blueGray-200 w-full'
                />
            </div>
            ...
            <div className='w-2/12 flex items-center justify-end space-x-6'>
                ...
                <Button href='#' size='md' type='secondary'>
                    <span>Sign In</span>
                </Button>
            </div>
        </header>
