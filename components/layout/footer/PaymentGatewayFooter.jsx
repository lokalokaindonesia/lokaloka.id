...
const PaymentGateway = () => {
    return (
        <div className='bg-white'>
            <div className='grid grid-flow-row container mx-auto px-2 md:px-6 lg:px-10 grid-rows-2 grid-cols-5 md:grid-rows-2 md:grid-cols-5 lg:grid-cols-10 lg:grid-rows-1 gap-4 items-center py-4 md:py-8'>
