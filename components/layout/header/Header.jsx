                ...
                <form method='post' className='w-full' action={`/search?s=${inputText}`}>
                    <div className='flex rounded-md shadow-sm w-full'>
                        <input
                            ...
                            id='search'
                            className='block w-full bg-white bg-opacity-100 text-black border-r-0 placeholder-white border-white px-2 py-2 md:px-3 md:py-3 shadow-sm text-xs focus:border-white focus:ring-0 rounded-l-0 rounded-l-md'
