            ...
            <div className='hidden md:block md:w-2/12 text-2xl font-extrabold text-orange-500 tracking-wide'>
                <a href='/'>
                    <div className='cursor-pointer'>
                        <img className='hidden md:block cursor-pointer ' src='/lokalokabiru.png' alt='' style={{ height: '40px' }} />
                ...
                <form method='post' className='w-full' action={`/search?s=${inputText}`}>
                    <div className='flex rounded-md shadow-sm w-full'>
                        <input
                            ...
                            id='search'
                            className='block w-full bg-white bg-opacity-100 text-slate-700 border-r-0 placeholder-white border-white px-2 py-2 md:px-3 md:py-3 shadow-sm text-xs focus:border-white focus:ring-0 rounded-l-0 rounded-l-md'
