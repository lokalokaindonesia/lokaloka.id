        ...
        <div className={`${bgColor} relative`}>
            <div className='w-full flex space-y-4 my-4 md:py-0 py-4 flex-col container mx-auto px-4 2xl:px-0'>
                ...
                <div className='flex lg:hidden w-full justify-between items-center'>
                    ...
                    <Button size='sm' href={() => router.push(`/specials/${sectionTitle.toLowerCase()}`)} type='tertiary' size='sm' display='flex' width='max'>
                ...
                <div className='hidden lg:flex w-full justify-between items-center'>
                    ...
                    <Button href={() => router.push(`/specials/${sectionTitle.toLowerCase()}`)} type='tertiary' size='sm' display='flex' width='max'>
