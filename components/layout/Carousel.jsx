...
import riverstoneDesktop from '../../public/images/banner/riverstonelaptop.jpg';
import riverstoneMobile from '../../public/images/banner/riverstonebatuhp.jpg';
import kotenaDesktop from '../../public/images/banner/kontenaLAPTOP.jpg';
import kontenaMobile from '../../public/images/banner/kontenaHP.jpg';
  ...
  return (
    <>
      <div className="my-4 hidden lg:block md:my-8 px-4 md:px-12 lg:px-16 drop-shadow-lg container mx-auto">
        <Swiper modules={[Navigation, Pagination, Autoplay]} spaceBetween={20} autoplay loop={itemLength > 1 ? true : false} slidesPerView={1} navigation pagination={{ clickable: true }} centeredSlides={true}>
          <SwiperSlide>
            <div className="w-full h-full cursor-pointer bg-slate-600 rounded-md">
              <Image src={comboHotelDesktop} alt="Promo" className="rounded-md" layout="responsive" width={6} priority quality={100} height={2} />
            </div>
          </SwiperSlide>
          <SwiperSlide>
            <div className="w-full h-full ///cursor-pointer bg-slate-600 rounded-md">
              <Image src={coverDesktop} alt="Promo" className="rounded-md" layout="responsive" width={6} priority quality={100} height={2} />
            </div>
          </SwiperSlide>
      ...
      <div className="my-4 lg:hidden md:my-8 px-4 md:px-12 lg:px-16 drop-shadow-md container mx-auto">
        <Swiper modules={[Navigation, Pagination, Autoplay]} spaceBetween={20} autoplay loop={itemLength > 1 ? true : false} slidesPerView={1} navigation pagination={{ clickable: true }} centeredSlides={true}>
          ...
          <SwiperSlide>
            <div className="w-full h-full cursor-pointer bg-slate-600 rounded-md">
              <Image src={comboHotelAndroid} alt="Promo" className="rounded-md" layout="responsive" width={6} priority quality={100} height={3} />
            </div>
          </SwiperSlide>
          <SwiperSlide>
            <div className="w-full h-full cursor-pointer bg-slate-600 rounded-md">
              <Image src={coverMobile} alt="Promo" className="rounded-md" layout="responsive" width={6} priority quality={100} height={3} />
            </div>
          </SwiperSlide>
